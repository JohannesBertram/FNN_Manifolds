"""
Calculates and compares tubularity scores for all considered layers. 

Set use_ground_truth_labels to differentiate between using ground truth stimulus labels,
and using HDBSCAN cluster labels.
"""
...
from tubes_utils import preprocess_curves, run_clustering, compute_cluster_metrics, aggregate_metrics, plot_scenario_overview, plot_per_cluster_bars, plot_radius_profiles, plot_scenario_overview_proper
...
data_paths = [
    ...
    os.path.abspath(os.path.join(os.pardir, 'data', 'sampled_data', 'tensor4d_fnn07_act_i3_n2000_SCL0_7_TL37_blocks2_maxFr_maxNr_seed1.npy')),#TODO
...
with plt.rc_context({**bundles.neurips2024(), **axes.lines()}):
    ...
    plt.tight_layout()
    if use_ground_truth_labels:
        plt.savefig("../fig/tubularity/metrics_ground_truth.pdf")
    else:
        plt.savefig("../fig/tubularitymetrics_hdbscan.pdf")
